...
const FreelancerRegistration = ({tab, setTab, handleEmailVerification, form, handleOnChange}) => {
...
const RecruiterRegistration = ({tab, setTab, handleEmailVerification, form, handleOnChange}) => {
  return (<Box position={'relative'}>
    <Container
      as={SimpleGrid}
      maxW={'7xl'}
...
const VerifyFreelancerEmail = ({otp, setOtp, handleOnSubmitFreelancer, handleOnChange, setTab}) => {
  return (
    <Flex
      minH={'100vh'}
      align={'center'}
...
const VerifyRecruiterEmail = ({otp, setOtp, handleOnSubmitRecruiter, handleOnChange, setTab}) => {
  return (
    <Flex
    minH={'100vh'}
    align={'center'}
...
export default function register() {
  ...
  const handleOnChangeOtp = (value, index) => {
    const newOtp = [...otp];
    newOtp[index] = value; // Update the OTP array at the specific index
    setOtp(newOtp);
    //setOtp(...otp, otp[index] = e.value);
  }
  ...
  return (
    <>
      {tab == "freelancer" && <FreelancerRegistration handleEmailVerification = {handleEmailVerification} tab={tab} setTab={setTab} form={form} handleOnChange={handleOnChange}/>}
      {tab == "recruiter" && <RecruiterRegistration handleEmailVerification={handleEmailVerification}  tab={tab} setTab={setTab} form={form} handleOnChange={handleOnChange}/>}
      {tab == "verifyFreelancerEmail" && <VerifyFreelancerEmail otp={otp} setOtp={setOtp} handleOnSubmitFreelancer={handleOnSubmitFreelancer} handleOnChange={handleOnChangeOtp} setTab={setTab} />}
      {tab == "verifyRecruiterEmail" && <VerifyRecruiterEmail otp={otp} setOtp={setOtp} handleOnSubmitRecruiter={handleOnSubmitRecruiter} handleOnChange={handleOnChangeOtp} setTab={setTab}/>}
